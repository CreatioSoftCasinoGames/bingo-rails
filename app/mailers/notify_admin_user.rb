class NotifyAdminUser < ActionMailer::Base
  ...
  def send_error_mail(error)
  	...
  	# @productionRecievers = "amrendra@creatiosoft.com, rishabh@creatiosoft.com, narendra@creatiosoft.com, jagadheeswarreddy@creatiosoft.com, manishkumar@creatiosoft.com"
  	@subject 	= "Error while - "+error.bug_type
  	@body 		=	"The following message will help you more to track the issue - \n\n"+error.exception
  	mail(to: @localRecivers, subject: @subject, body: @body)
  end
